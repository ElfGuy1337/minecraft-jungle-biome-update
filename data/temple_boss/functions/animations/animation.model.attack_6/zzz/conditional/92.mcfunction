...
tag @s add aj.temple_boss.anim.animation.model.attack_6
execute if score .aj.temple_boss.framerate aj.i matches ..-1 run scoreboard players set @s aj.frame 74
