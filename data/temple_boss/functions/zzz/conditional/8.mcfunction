...
execute as @e[type=minecraft:area_effect_cloud,tag=aj.temple_boss.bone,distance=..12.326] if score @s aj.id = .this aj.id run function temple_boss:zzz/execute/14
execute as @e[type=minecraft:armor_stand,tag=aj.temple_boss.bone,distance=..12.326] if score @s aj.id = .this aj.id run function temple_boss:zzz/execute/15
